...
extension SkirClient.Internal {
    ...
    public final class StructAdapter<Frozen, Mutable>: SkirClient.TypeAdapter {
        ...
        public func encode(_ input: Frozen, out: inout [UInt8]) {
            ...
            if totalSlotCount <= 3 {
                ...
                out.append(250)
                SkirClient.encodeUInt32(UInt32(totalSlotCount), out: &out)
            }
        ...
        private func encodeExtraJsonElement(_ element: Any, out: inout [UInt8]) {
            if let num = element as? NSNumber {
                SkirClient.encodeInt32(num.int32Value, out: &out)
            } else if let arr = element as? [Any] {
                if arr.count <= 3 {
                    out.append(246 + UInt8(arr.count))
                } else {
                    out.append(250)
                    SkirClient.encodeUInt32(UInt32(arr.count), out: &out)
                }
        ...
        public func decode(_ input: inout [UInt8], keepUnrecognizedValues: Bool) throws -> Frozen {
            ...
            if wire == 250 {
                ...
                guard decoded >= 0 else {
                    throw SkirClient.DeserializeError.schema("unexpected negative struct slot count")
                }
