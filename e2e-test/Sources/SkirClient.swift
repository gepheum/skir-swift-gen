...
extension SkirClient.IndirectOptional: ExpressibleByNilLiteral {
    public init(nilLiteral: ()) { self = .none }
}

extension SkirClient.IndirectOptional: CustomStringConvertible where T: CustomStringConvertible {
...
extension SkirClient.IndirectOptional: Equatable where T: Equatable {
