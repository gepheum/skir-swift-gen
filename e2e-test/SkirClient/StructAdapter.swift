...
extension Internal {
    ...
    public final class StructAdapter<Frozen, Mutable>: TypeAdapter {
        ...
        private let getUnrecognized: (Frozen) -> UnrecognizedFields<Frozen>
        private let setUnrecognized: (Mutable, UnrecognizedFields<Frozen>) -> Void
        ...
        public init(
            ...
            getUnrecognized: @escaping (Frozen) -> UnrecognizedFields<Frozen>,
            setUnrecognized: @escaping (Mutable, UnrecognizedFields<Frozen>) -> Void
        ) {
        ...
        private func toReadableJson(_ input: Frozen, indent: String, out: inout String) {
            ...
            for entry in orderedEntries {
                ...
                writeJsonEscapedString(entry.name(), out: &out)
                out.append(": ")
        ...
        private func fromDenseJson(_ arr: [Any], target: Mutable, keepUnrecognized: Bool) throws {
            ...
            if keepUnrecognized {
                ...
                if arr.count > recognizedMax {
                    ...
                    let ud = UnrecognizedFieldsData<Frozen>(
